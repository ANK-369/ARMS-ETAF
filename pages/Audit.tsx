...
const AutomatedAudit = ({ data }: { data: AppData }) => {
  ...
  const [diningName, setDiningName] = useState("የሜድሮክ ግብር ቤት ኮምቴ ሰብሳቢ");
  ...
  const PrintableContent = ({ isPrintTarget = false }: { isPrintTarget?: boolean }) => {
    ...
    marketChunks.forEach((chunk, chunkIdx) => {
      ...
      sectionsToRender.push({
        id: `market-${chunkIdx}`,
        render: () => (
          <div id={chunkIdx === 0 ? "market-expense-section" : undefined}>
    ...
    transferChunks.forEach((chunk, chunkIdx) => {
      ...
      sectionsToRender.push({
        ...
        render: () => (
          <div id={chunkIdx === 0 ? "transferred-items-section" : undefined}>
            <h2 className="text-xl font-bold text-center underline mb-6 text-black uppercase">
    ...
    manpowerChunks.forEach((chunk, chunkIdx) => {
      ...
      sectionsToRender.push({
        ...
        render: () => (
          <div id={chunkIdx === 0 ? "manpower-section" : undefined}>
            <h2 className="text-xl font-bold text-center underline mb-6 text-black uppercase">
