...
import { ETHIOPIAN_MONTHS, ETHIOPIAN_MONTHS_AMHARIC, getDaysInEthiopianMonth } from '../services/ethiopianDate';
...
const DataEditor: React.FC = () => {
  ...
  const isRecordInMonth = (item: any) => {
      ...
      if (activeCollection === 'manpower') {
          ...
          const monthEnd = `${targetPrefix}-${daysInMonth.toString().padStart(2, '0')}`;
